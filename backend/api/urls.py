...
urlpatterns = [
    ...
    path("dashboards/admin/", views.dashboard_admin, name="dashboard_admin"),
    path("dashboards/teacher/", views.dashboard_teacher, name="dashboard_teacher"),
    path("dashboards/student/", views.dashboard_student, name="dashboard_student"),
    path("teachers/activities/", views.teacher_activities, name="teacher_activities"),
    ...
    path("justifications/", views.justifications, name="justifications"),
    path(
        "justifications/<int:justification_id>/",
        views.justification_detail,
    ...
    path(
        ...
        views.academic_target_detail,
        name="academic_target_detail",
    ),
    path("exam-submissions/", views.exam_submissions, name="exam_submissions"),
    path(
